...
func (x *EventResponse) Reset() {
	*x = EventResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_event_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EventResponse) Descriptor() ([]byte, []int) {
	return file_model_event_proto_rawDescGZIP(), []int{3}
}
...
var file_model_event_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0xc9, 0x01, 0x0a, 0x0a, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x76, 0x65,
	...
	0x09, 0x52, 0x09, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x18, 0x0a, 0x07,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x44, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x73, 0x75,
	...
	,
...
var file_model_event_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_model_event_proto_goTypes = []interface{}{
	(*EventParam)(nil),    // 0: model.EventParam
	(*ResponseParam)(nil), // 1: model.ResponseParam
	(*EventFilter)(nil),   // 2: model.EventFilter
	(*EventResponse)(nil), // 3: model.EventResponse
}
var file_model_event_proto_depIdxs = []int32{
	0, // 0: model.EventResponse.events:type_name -> model.EventParam
	2, // 1: model.EventStore.GetEvents:input_type -> model.EventFilter
	0, // 2: model.EventStore.CreateEvent:input_type -> model.EventParam
	3, // 3: model.EventStore.GetEvents:output_type -> model.EventResponse
	1, // 4: model.EventStore.CreateEvent:output_type -> model.ResponseParam
...
func file_model_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_event_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
...
func (c *eventStoreClient) GetEvents(ctx context.Context, in *EventFilter, opts ...grpc.CallOption) (*EventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/model.EventStore/GetEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventStoreClient) CreateEvent(ctx context.Context, in *EventParam, opts ...grpc.CallOption) (*ResponseParam, error) {
	...
	err := c.cc.Invoke(ctx, "/model.EventStore/CreateEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventStore_GetEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.EventStore/GetEvents",
	}
...
func _EventStore_CreateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.EventStore/CreateEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
